...
id,kode,nama,categoryId,mitra,stok,modal,p1,p2,p3,p4,lokasiItem,lokasiStock,notes
...
create index barang_category_id_idx on public.barang
(category_id);
...
-- and deliberately create NO policies