...
def create_account(email: str, full_name: str, role: str, password: str) -> None:
    ...
    # email_confirm=True marks the address as verified, so the account can log
    # in immediately -- there is no inbox to click a confirmation link in.
...
if __name__ == "__main__":
    ...
    # Prompted rather than passed as a flag, so it stays out of your shell history.
